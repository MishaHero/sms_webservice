...
?>
    <div class="container">
      <h1>ActiveXperts SMS Component PHP Samples</h1>
      <hr />
      <p>
        ...
        For more details, <a href="https://www.activexperts.com/support/kb/index.asp?productcode=004&idcategory=457" target="_blank">click here</a>.
      </p>
      <div class="content">
        <h1>Table of contents</h1>
        <input type="button" class="Button" onclick="window.location='includes/gsm.php';"       value="SMS via GSM" />
